...
<div class="embed-container">
  <iframe
      src="https://www.youtube.com/embed/-KlYuiTADXI"
      width="700"
      height="480"
      frameborder="0"
      allowfullscreen="">
...
Mithilfe von Piskel habe ich der Spielfigur eine neue Optik gegeben. In dieser sind auch die benötigten Texturen für Animationen vorhanden. Verwendet wird diese Datei genauso wie in der Spielfeldgenerierung. Die benötigte Textur wird aus der gesamten Datei herausgeschnitten und entsprechend eingefügt. Beim Erstellen der Figur habe ich versucht, die eventuell kollidierenden Punkte immer mit einer visuellen Textur zu versehen. Besonders gut zu sehen ist dies bei der Sprunganimation (die letzte Reihe im Bild). Hier war ich dazu gezwungen, die Figur beim Sprung den Arm heben zu lasse, um diese Kollision anzuzeigen. Da ich nur mit Rechtecken arbeite, muss ich da besonders viel Wert drauf legen. Andernfalls entstehen unsichtbare Kollisionen, die das Spielerlebnis stark negativ beeinflussen. Die erstellten Texturen sind in dem folgenden Bild zu sehen:<br/>
